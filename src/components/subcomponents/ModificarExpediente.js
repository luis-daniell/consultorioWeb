...
const ModificarExpediente = ({props}) => {
    ...
    return ( 
        <div className="">
            ...
            <div className="bg-colorFondo lg:h-auto lg:w-4/5 lg:box-border lg:left-auto lg:float-right">
                <Barra/>
                        ...
                        <div className="w-10/12">
                            ...
                            <div className="bg-colorFondo pb-12 rounded-b-extra">
                                ...
                                <div className=" flex justify-around">
                                    <label className="text-tercerColor hidden sm:text-2xl sm:w-3/12">Nombre</label>
                                    <input 
                                ...
                                <div className="flex justify-around mt-6">
                                    <label className="text-tercerColor hidden sm:text-2xl sm:w-3/12">Apellidos</label>
                                    <input 
                                        type="text" placeholder="Nombre" 
                                        className="w-11/12 sm:w-8/12 shadow appearance-none border-2 py-2 px-3"
                                        id="apellidos"
                                ...
                                <div className=" flex justify-around mt-6">
                                    <label htmlFor="descripcion" className="text-tercerColor  hidden sm:text-2xl sm:w-3/12">Domicilio: </label>
                                    <textarea
                                        className="w-11/12 sm:w-8/12 shadow appearance-none border-2 py-2 px-3"
                                ...
                                <div className="flex justify-around mt-6">
                                    <label className="text-tercerColor  hidden sm:text-2xl sm:w-3/12">Telefono: </label>
                                    <input 
                                ...
                                <div className="flex justify-around mt-6">
                                    <label htmlFor="descripcion" className="text-tercerColor hidden sm:text-2xl sm:w-3/12">E-mail: </label>
                                    <input 
                                ...
                                <div className="flex justify-around mt-6">
                                    <label htmlFor="descripcion" className="text-tercerColor hidden sm:text-2xl sm:w-3/12">Antecedentes Familiares: </label>
                                    <textarea
                                        className="w-11/12 sm:w-8/12 shadow appearance-none border-2 py-2 px-3"
                                ...
                                <div className="flex justify-around mt-6">
                                    <label htmlFor="descripcion" className="text-tercerColor hidden sm:text-2xl sm:w-3/12">Estilos de vida: </label>
                                    <textarea
                                        className="w-11/12 sm:w-8/12 shadow appearance-none border-2 py-2 px-3"
                                ...
                                <div className="flex justify-around mt-6">
                                    <label htmlFor="descripcion" className="text-tercerColor hidden sm:text-2xl sm:w-3/12">Diagnóstico: </label>
                                    <textarea
                                        className="w-11/12 sm:w-8/12 shadow appearance-none border-2 py-2 px-3"
                                ...
                                {presion2 === "" ? null : 
                                    <div className="flex justify-around mt-6">
                                        <label htmlFor="descripcion" className="text-tercerColor hidden sm:text-2xl sm:w-3/12">Presion: </label>
                                        <input 
                                ...
                                {peso2 === "" ? null : 
                                    <div className="flex justify-around mt-6">
                                        <label htmlFor="descripcion" className="text-tercerColor hidden sm:text-2xl sm:w-3/12">Peso: </label>
                                        <input 
                                            type="text" placeholder="Presión" 
                                            className="w-11/12 sm:w-8/12 shadow appearance-none border-2 py-2 px-3"
                                            id="peso"
                                ...
                                {talla2 === "" ? null : 
                                    <div className="flex justify-around mt-6">
                                        <label htmlFor="descripcion" className="text-tercerColor hidden sm:text-2xl sm:w-3/12">Talla: </label>
                                        <input 
                                            type="text" placeholder="Presión" 
                                            className="w-11/12 sm:w-8/12 shadow appearance-none border-2 py-2 px-3"
                                            id="talla"
